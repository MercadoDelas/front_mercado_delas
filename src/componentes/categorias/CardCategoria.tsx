      ...
      <div className="mt-10">
        <div className="w-96 inline-flex flex-col space-y-2 items-center justify-end flex-1 h-full p-4 bg-violet-500 rounded-xl">
          ...
          <div className="rounded mr-auto flex items-center justify-center">
            <div className="opacity-95 border rounded-lg border-white px-4 mr-4w-20">
              <Link
                to={`/editarCategoria/${categoria.id}`}
                className="m-auto inset-0 text-sm font-medium leading-normal text-center text-white py-2 "
              >
                Editar
              </Link>
            </div>
